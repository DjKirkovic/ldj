      ...
      <div className="flex justify-between pt-10">
        ...
        <div className="w-[61%] flex flex-col gap-7 text-black">
          ...
          <p><b>Stifter</b><br />
            ...
            Martin har en BSc Multimedieproduktion og har arbejdet som prof. fotograf i 7+ år. Hans erfaring tæller en bred vifte af fotogenrer, han har arbejdet over fire kontinenter, og kunder inkluderer både private og VIPs, medieorganisationer og kendte firmaer som BBC og NASA.    
          </p>
          <p><b>Feedback</b><br />
