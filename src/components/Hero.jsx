    ...
    <Container className="border-b border-black">
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-7xl font-bold text-black">
            <span className="text-yellow-400">foto </span><span className="text-blue-500">24</span><span className="text-green-500">/</span><span className="text-red-500">7</span>
            <br />
          </h2>
      </div>
      ...
      <div className="flex justify-between pt-2">
          ...
          <div className="text-base text-lightText pt-4 font-medium">
            <p>Vi tilbyder:</p>
              <ul class="list-disc mb-4 ml-4">  
                <li><Link to={"services/studio"} class="text-blue-500 hover:text-green-500">Portræt</Link></li>
        ...
        {/* Right part */}
        <div className="w-[35%] bg-[#212428] rounded-lg shadow-md shadow-black overflow-hidden group">
